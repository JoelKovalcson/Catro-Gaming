...
function signUp() {
    return ( 
        ...
        <form>
            ...
            <p class="text-gray-800 mt-6 text-center">Don't have an account? <a href="#!"
                class="text-blue-600 hover:text-blue-700 focus:text-blue-700 transition duration-200 ease-in-out">Sign Up</a>
            </p>
        </form>
        </div>
    )
