	...
	// else {
		return (
			<header className='flex flex-col md:border-b-4 md:border-double md:border-pastel-purple md:flex-row md:justify-between h-96 md:h-48'>
				<Link to='/' className='sm:w-full border-b-4 border-double border-pastel-purple md:border-none h-96 sm:h-48 bg-logo bg-center bg-contain bg-no-repeat md:bg-right lg:bg-left lg:w-1/2 text-center p-4 '>
					{/* <Dropdown/> */}
				</Link>
				<div className='flex justify-center md:justify-end lg:hidden w-full md:w-1/5 md:ml-24 border-b-4 md:border-none border-double border-pastel-purple p-4'>
