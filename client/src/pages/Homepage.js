	...
	return (
		<>
			<div className='flex justify-center my-6'>
				<div className='flex flex-col w-1/4 rounded border border-8 border-double border-pastel-purple bg-light-background'>
					...
					<button className='self-center w-3/4 h-12 m-4 rounded bg-pastel-purple'>
						<Link to="/multiplayer" className='text-black'>Mulitplayer</Link>	
					</button>		
				</div>
			</div>
		</>
